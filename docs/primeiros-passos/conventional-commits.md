...
A título de curiosidade, em português também é conhecido como Commits Semânticos.

Esse documento foi copiado diretamente do 
[Conventional Commits v1.0 pt-BR](https://www.conventionalcommits.org/pt-br/v1.0.0/).

**Atenção!** Não use o tipo `refactor:` com `BREAKING CHANGES`. Por definição,
essa combinação é _incompatível_. Para mais detalhes, leia essa as issues
[#229](https://github.com/conventional-commits/conventionalcommits.org/issues/229)
e
[#457](https://github.com/conventional-commits/conventionalcommits.org/issues/457)
.
